    ...
    <Link href="/" class="block mb-3">&xlarr;</Link>
        ...
        <div class="add_task-form">
            ...
            <div class="flex justify-center">
                    ...
                    <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 my-32" @submit.prevent="saveCategory" enctype="multipart/form-data">
                            <div class="mb-4">
...
const saveCategory = () => {
    ...
    form.post('/categories', form, {
        onStart: () => console.log('Submitted Attempted'),
        onFinish: () => console.log('Submitted granted')
    })
